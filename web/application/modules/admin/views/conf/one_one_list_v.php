		...
		<div class="container">
			<div class="content-inner">
				<form action="" id="page_form" method="get" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<option value 	<?php if(!isset($input[ 'sfl']) || !$input[ 'sfl']) echo "selected";?>>전체</option>
								<option value="title" <?php  if(isset($input[ 'sfl']) && $input[ 'sfl']=="title" ) echo "selected";?> >질문제목</option>
								<option value="content" <?php  if(isset($input[ 'sfl']) && $input[ 'sfl']=="content" ) echo "selected";?> >질문내용</option>
							</select>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="sdate">질문일</label>
				...
				<h5>* 상품명이 있는 것은 상품 질문 입니다.<br>* 없는것은 1:1 질문입니다.</h5>
					...
					<table class="table table-headered table-condensed">
						<thead>
							...
							<tr>
								...
								<td>
									<a href="<?php echo $this->urilink."one_one_detail/".$val['id'];?>" > <?php echo $val['title'];?> </a>
								</td>

								<td>
									<?php echo ($val['memberId']);?>
								</td>
								...
								<td>							
									<?php echo ($val['productId'])?$val['productName']:"";?>
								</td>
								<td>							
									<?php echo ($val['R_id'])?"답변완료":"답변대기";?>
								</td>
								<td>
