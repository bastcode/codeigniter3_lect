	...
	<div class="row">
		<div class="container">
			<div class="content">
				...
				<!-- .header-wrap -->
				<form class="form_post" accept-charset="utf-8" enctype="multipart/form-data" action="/admin/conf/event_proc/update" method="post" >
					...
					<table class="table table-headered table-condensed ">
						...
						<tbody>
							<tr>								
								...
								<td><?php echo ($info['tit_img'])?"<img src='".$info['tit_img']."' width=25%>":"없음";?> <br> <input type="file" name="eventTitleImage[]"></td>
								<td><input type="text" id="sdate" name="startDate" value="<?php echo $info['startDate'];?>"> </td>
								<td><input type="text" id="edate" name="endDate" value="<?php echo $info['endDate'];?>"> </td>
					...
					<table class="table table-headered table-condensed ">
						...
						<tbody>
							<tr>								
								...
								<td><?php echo ($info['tit_img'])?"<img src='".$info['couponImage1']."' width=25%>":"없음";?><br>
									<input type="file" name="couponImage1[]"></td>
								<td><?php echo ($info['tit_img'])?"<img src='".$info['couponImage2']."' width=25%>":"없음";?><br>
									<input type="file" name="couponImage2[]"></td>			
							</tr>
						</tbody>
					</table>
				</section>
