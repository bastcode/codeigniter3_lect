		...
		<div class="container">
			<div class="content-inner">
				<form action="" id="page_form" method="get" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<option value 	<?php if(!isset($input[ 'sfl']) || !$input[ 'sfl']) echo "selected";?>>전체</option>
								<option value="title" <?php  if(isset($input[ 'sfl']) && $input[ 'sfl']=="title" ) echo "selected";?> >제목</option>
								<option value="content" <?php  if(isset($input[ 'sfl']) && $input[ 'sfl']=="content" ) echo "selected";?> >내용</option>
							</select>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="sdate">이벤트일</label>
					...
					<div class="form-group">
						...
						<a  href="/admin/conf/event_form" class="btn btn-success">이벤트 게시물 생성</a>
						</div>
					</div>
				</form>
					...
					<table class="table table-headered table-condensed">
						<thead>
							...
							<tr>
								...
								<td>
								<a href="<?php echo $this->urilink."event_detail/".$val['id'];?>" > <img src="<?php echo $val['tit_img'];?>" width=50%> </a>
								</td>
								<td>
									<a href="<?php echo $this->urilink."event_detail/".$val['id'];?>" > <?php echo $val['title'];?> </a>
								</td>							
								<td>
									<?php echo$val['startDate'];?>~<?php echo$val['endDate'];?>
								</td>
								<td>
									<button class="btn btn-danger delBtn" data-id="<?php echo$val['id'];?>">삭제</button>
								</td>
