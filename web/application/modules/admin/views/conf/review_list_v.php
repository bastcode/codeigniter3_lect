		...
		<div class="container">
			<div class="content-inner">
				<form action="" id="page_form" method="get" class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<option value 	<?php if(!isset($input[ 'sfl']) || !$input[ 'sfl']) echo "selected";?>>전체</option>
								...
								<option value="content" <?php  if(isset($input[ 'sfl']) && $input[ 'sfl']=="content" ) echo "selected";?> >리뷰내용</option>
							</select>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-sm-2" for="sdate">리뷰일</label>
					...
					<table class="table table-headered table-condensed">
						<thead>
							...
							<tr>
								...
								<td>
									<div class="title"><a href="<?php echo $this->urilink."review_detail/".$val['id'];?>"><?php echo ($val['productName']);?></a></div>
								</td>
								<td>
									<div class="title"><a href="<?php echo $this->urilink."review_detail/".$val['id'];?>"><?php echo $val['content'];?> </a></div>
								</td>						
...
<form id="list_form" action="/admin/conf/review_proc/delete" method="post">
