	...
	<div class="row">
		<div class="container">
			<div class="content">
				...
				<!-- .header-wrap -->
				<form class="form_post" accept-charset="utf-8" enctype="multipart/form-data" action="/admin/conf/making_proc/insert" method="post" >
				...
				<section class="sec_detail">
					...
					<textarea name="contentM" id="contentM" style="width: 360px; height: 400px;"></textarea>
				</section>
