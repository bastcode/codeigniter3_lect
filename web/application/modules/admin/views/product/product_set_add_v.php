			...
			<div class="content">
					...
					<div class="header-wrap well">
						<header class="list-page-header">
							<h1 class="member-id text-center">셋트 상품 생성</h1>
					...
					<form method="post" accept-charset="utf-8" enctype="multipart/form-data" action="/admin/product/product_set_crud/add" class="form_post">
							...
							<table class="table table-bordered table-condensed">
								<tbody>
									<tr>
										<th>상품이름</th>
										<td class="form-inline">
											<input id="productName" name="productName" class="span5" type="text" value="" required />
										</td>
										<th>상품 등록일</th>
						...
						<section class="ri-price-info">
							...
							<table class="ri-pi-table table table-bordered table-condensed">
								...
								<tbody>
									<tr>
										<td class="form-inline">
											<input id="price" name="price" class="span3 text-right" type="text" value="" required />
										</td>								
										<td class="evt-price-td form-inline">
											<input id="eventPrice" name="eventPrice" class="span3 text-right" type="text" value="" required />
										</td>								
										<td class="evt-price-td form-inline">
											<input id="usd" name="usd" class="span3 text-right" type="hidden" value="" />
											<input id="setDiscountPer" name="setDiscountPer" class="span3 text-right" type="text" value="" />
										</td>
									</tr>
							...
							<tbody>
								<tr>
									...
									<td class="evt-price-td form-inline">
										...
										<input  name="setProductId" id="exption_product" class="span3 text-right" type="hidden" value="" readonly required />
									</td>								
								</tr>
							</tbody>
						</table>
