					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<select name="sfl" id="sfl" class="form-control">
								<option value="title" <?php  if(isset($input[ 'sfl']) && $input[ 'sfl']=="title" ) echo "selected";?> >질문명</option>
					...
					<table class="table table-headered table-condensed">
						<thead>
							...
							<tr>
								...
								<td>
									<a href="<?php echo $this->uri."one_one_detail/".$val['id'];?>"><?php echo $val['title'];?> </a>
								</td>
